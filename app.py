...
def home():
    ...
    return render_template('elements.html', data = fetchdata)
...
#    cur.execute("SELECT rec_time FROM test WHERE (rec_name) ='Cai, YunYou'")
#    fetchdata = cur.fetchall()
#    cur.close()
#    return render_template("generic.html", data = fetchdata)
